...
- January 1, 2023
The Search Page and App Icon was added, and cleaned the unused resources, class, attributes, etc. Updated the Nested Scroll on Search Page. Fixed Chapter List by adding hasfixedsize and removed wrap content.
